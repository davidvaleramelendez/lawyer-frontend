...
const LayoutWrapper = props => {
  ...
  const bookmarkStore = store.navBookmark
  const globalSearchStore = store.navGlobalSearch
  //** Vars
  ...
  return (
    <div
      className={classnames('app-content content overflow-hidden', {
        ...
        'show-overlay': bookmarkStore.searchQuery.length || (globalSearchStore.params && globalSearchStore.params.search && globalSearchStore.params.search.length)
      })}
    >
