...
const Tasks = (props) => {
  ...
  const handleSearchFilter = (value) => {
    ...
    handleTodoLists(folder, value, dateInput, sort, tagFolder)
  }

  // ** Function to getTodoList based on search
  const handleDateFilter = (value) => {
    setDateInput(value)
    handleTodoLists(folder, searchInput, value, sort, tagFolder)
  }
  ...
  const handleSort = (event, val) => {
    ...
    setSort(val)
    handleTodoLists(folder, searchInput, dateInput, val, tagFolder)
  }
